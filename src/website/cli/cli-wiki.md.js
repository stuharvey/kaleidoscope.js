export default `
# Kaleidoscope CLI Usage & Documentation

Kaleidoscope is open source on [Github](https://github.com/stuharvey/kaleidoscope.js) - help improve these docs. :D

### Installation

Install kaleidoscope using [NPM](https://nodejs.org/en/download), and add it to your package.json dependencies:

\`npm install kaleidoscope --save\`
...
An example of a config file can be found on [Github](https://github.com/stuharvey/kaleidoscope.js/blob/master/test/config.json)
