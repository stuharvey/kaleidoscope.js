...
Next call svgurt with a [config](https://github.com/stuharvey/kaleidoscope.js#config) object:
...
`svgurt config.json`.
[Config documentation](https://github.com/stuharvey/kaleidoscope.js#config).
